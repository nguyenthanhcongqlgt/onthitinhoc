...
export const AI_PROVIDERS = [
  {
    ...
    icon: '🌟',
    description: 'Ưu tiên Gemini 3.7 & 3.6 Flash để đạt chất lượng suy luận cao nhất. Tự động chuyển dự phòng xuống Gemini 3.5 Flash Lite (500 lượt/ngày) khi quá tải.',
    defaultModel: 'gemini-3.7-flash',
    models: [
      { id: 'gemini-3.7-flash', name: 'Gemini 3.7 Flash (⭐ Ưu tiên 1 - Mới nhất, Đỉnh cao suy luận & Giải thuật)' },
      { id: 'gemini-3.6-flash', name: 'Gemini 3.6 Flash (⭐ Ưu tiên 2 - Thế hệ 3.6 cao cấp)' },
      ...
      { id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash (Ổn định cao, Hiểu code tốt - 20 lượt/ngày)' },
      { id: 'gemini-3.5-flash', name: 'Gemini 3.5 Flash (Thế hệ 3.5 - 20 lượt/ngày)' },
      { id: 'gemini-3-flash', name: 'Gemini 3 Flash (Thế hệ 3.0 - 20 lượt/ngày)' },
      { id: 'gemini-2.5-flash-lite', name: 'Gemini 2.5 Flash Lite (Nhẹ - 20 lượt/ngày)' },
      { id: 'gemini-2.0-flash', name: 'Gemini 2.0 Flash (Thế hệ 2.0)' },
      { id: 'gemini-1.5-flash', name: 'Gemini 1.5 Flash (Bản 1.5 truyền thống)' },
    ],
