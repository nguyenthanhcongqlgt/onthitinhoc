...
export const AssignExamModal: React.FC<AssignExamModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in">
      <div className="w-full max-w-lg rounded-3xl border border-slate-800 bg-slate-950 shadow-2xl flex flex-col max-h-[90vh]">
        {/* Header */}
        ...
        {/* Action Buttons */}
        <div className="border-t border-slate-800 p-6 pt-4 flex items-center justify-between gap-3 shrink-0">
          {exam.is_assigned ? (
            <button
              type="button"
