...
export const BulkUserImportModal: React.FC<Props> = ({ onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-sm p-4 overflow-y-auto">
      <div className="relative w-full max-w-2xl rounded-3xl border border-slate-700 bg-slate-900 shadow-2xl p-6 flex flex-col">
        {/* Header */}
        ...
        <div className="mt-4 space-y-3">
          ...
          <textarea
            ...
            className="w-full font-mono text-xs rounded-xl border border-slate-700 bg-slate-950 p-4 text-emerald-400 placeholder-slate-600 focus:border-blue-500 focus:outline-none"
          />
